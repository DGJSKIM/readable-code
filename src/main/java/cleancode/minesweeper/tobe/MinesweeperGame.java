...
public class MinesweeperGame {
    ...
    private static final int CELL_INPUT_ROW_INDEX = 1;
    private static final int CELL_INPUT_COL_INDEX = 0;
    ...
    private static int getSelectedRowIndex(String cellInput) {
        char cellInputRow = cellInput.charAt(CELL_INPUT_ROW_INDEX);
        return convertRowFrom(cellInputRow);
    }

    private static int getSelectedColIndex(String cellInput) {
        char cellInputCol = cellInput.charAt(CELL_INPUT_COL_INDEX);
